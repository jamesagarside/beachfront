...
/**
 * Walking-skeleton shell. The role-driven panes (Attention queue, ready-for-agent
 * pool) arrive in later slices; this slice aggregates open issues (#5) and recent
 * Agent runs (#10) across every Registry repo, grouped by repo, gated on the
 * Viewer's identity (ADR-0001).
 */
